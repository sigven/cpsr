...
cat("<b>NOTE:</b> Biomarkers registered in CIViC/CGI are provided at different _resolutions_ (i.e. filter <b>Biomarker resolution</b>). The accuracy of a match between a variant in the sample and a clinical evidence item (biomarker) will vary accordingly (highlighted by gene symbols with different color backgrounds):\n\n")
...
crosstalk::bscols(
  ...
  list(
    ...
    crosstalk::filter_select("BIOMARKER_RESOLUTION", "Biomarker resolution", variants_germline_predisposing_shared, ~BIOMARKER_RESOLUTION)
  )
)
...
DT::datatable(variants_germline_predisposing_shared,
  ...
  DT::formatStyle(
    color = "white", "SYMBOL", "BIOMARKER_RESOLUTION", fontWeight = "bold", `text-align` = "center",
    backgroundColor = DT::styleEqual(
...
crosstalk::bscols(
  ...
  list(
    ...
    crosstalk::filter_select("BIOMARKER_RESOLUTION", "Biomarker resolution", variants_germline_predictive_shared, ~BIOMARKER_RESOLUTION),
...
crosstalk::bscols(
  ...
  list(
    ...
    crosstalk::filter_select("BIOMARKER_RESOLUTION", "Biomarker resolution", variants_germline_prognostic_shared, ~BIOMARKER_RESOLUTION)
  )
)
##cat("The table below lists all variant-evidence item associations:", sep = "\n")
htmltools::br()
...
crosstalk::bscols(
  ...
  list(
    ...
    crosstalk::filter_select("BIOMARKER_RESOLUTION", "Biomarker resolution", variants_germline_diagnostic_shared, ~BIOMARKER_RESOLUTION)
  )
)
##cat("The table below lists all variant-evidence item associations:", sep = "\n")
htmltools::br()
