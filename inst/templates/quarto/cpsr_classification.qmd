...
if (missing_class_items[["class5"]][["ClinVar"]] == F | (missing_class_items[["class5"]][["CPSR_ACMG"]] == T & missing_class_items[["class5"]][["ClinVar"]] == T)) {
  cat("")
  cat("#### ClinVar {.active}")
  cat("")
} else {
...
variants_class5_clinvar <-
  dplyr::filter(
    cps_report[["content"]][["snv_indel"]][["disp"]][["class5"]], CPSR_CLASSIFICATION_SOURCE == "ClinVar") |>
  head(2000)
...
if (missing_class_items[["class5"]][["ClinVar"]] == T & missing_class_items[["class5"]][["CPSR_ACMG"]] == F) {
  cat("")
...
```{r class5_cpsr_other, echo=F, results = 'asis', eval = show_class_filters[['class5']][['CPSR_ACMG']]}
...
if (missing_class_items[["class4"]][["ClinVar"]] == F | (missing_class_items[["class4"]][["CPSR_ACMG"]] == T & missing_class_items[["class4"]][["ClinVar"]] == T)) {
  cat("")
  cat("#### ClinVar {.active}")
  cat("")
} else {
...
if (missing_class_items[["class4"]][["ClinVar"]] == T & missing_class_items[["class4"]][["CPSR_ACMG"]] == F) {
  cat("")
  cat("#### Non-ClinVar {.active}")
  cat("")
} else {
...
```{r class4_cpsr_other, echo=F, results = 'asis', eval = show_class_filters[['class4']][['CPSR_ACMG']]}
...
if (missing_class_items[["class3"]][["ClinVar"]] == F | (missing_class_items[["class3"]][["CPSR_ACMG"]] == T & missing_class_items[["class3"]][["ClinVar"]] == T)) {
  cat("")
  cat("#### ClinVar {.active}")
  cat("")
} else {
...
```{r vus_caution_note, echo=F, results = "asis", include = show_class_filters[['class3']][['CPSR_ACMG']]}
...
```{r class3_cpsr_other, echo=F, results = 'asis', eval = show_class_filters[['class3']][['CPSR_ACMG']]}
...
if (missing_class_items[["class2"]][["ClinVar"]] == F | (missing_class_items[["class2"]][["CPSR_ACMG"]] == T & missing_class_items[["class2"]][["ClinVar"]] == T)) {
  cat("")
  cat("#### ClinVar {.active}")
  cat("")
} else {
...
if (missing_class_items[["class2"]][["ClinVar"]] == T & missing_class_items[["class2"]][["CPSR_ACMG"]] == F) {
  cat("")
  cat("#### Non-ClinVar {.active}")
  cat("")
} else {
...
```{r class2_cpsr_other, echo=F, results = 'asis', eval = show_class_filters[['class2']][['CPSR_ACMG']]}
...
if (missing_class_items[["class1"]][["ClinVar"]] == F | (missing_class_items[["class1"]][["CPSR_ACMG"]] == T & missing_class_items[["class1"]][["ClinVar"]] == T)) {
  cat("")
  cat("#### ClinVar")
  cat("")
} else {
...
if (missing_class_items[["class1"]][["ClinVar"]] == T & missing_class_items[["class1"]][["CPSR_ACMG"]] == F) {
  cat("")
  cat("#### Non-ClinVar {.active}")
  cat("")
} else {
...
```{r class1_cpsr_other, echo=F, results = 'asis', eval = show_class_filters[['class1']][['CPSR_ACMG']]}
