...
<br>
   ...
   *  A total of n = __`r tot_variants[['class5']][['Other']]`__ <i><b>non-ClinVar</b></i> variants (i.e. not submitted in ClinVar) are classified with a <i>Pathogenic</i> clinical significance by CPSR (ACMG criteria - based on population frequency and variant effect).
...
variants_class5_other <-
  dplyr::filter(
    ...
    CPSR_CLASSIFICATION_SOURCE == "Other") |>
  head(2000)
...
*  A total of n = __`r tot_variants[['class4']][['Other']]`__ <i><b>non-ClinVar</b></i> variants (i.e. not submitted in ClinVar) are classified with a <i>Likely Pathogenic</i> clinical significance by CPSR (ACMG criteria - based on population frequency and variant effect).
* **NOTE - variants displayed here constitute the top 2000 variants for each of the ClinVar and non-ClinVar variant sets (due to display limitations with client-side tables)**
...
*  A total of n = __`r tot_variants[['class3']][['Other']]`__ <i><b>non-ClinVar</b></i> variants (i.e. not submitted in ClinVar) are classified with a <i>VUS</i> clinical significance by CPSR (ACMG criteria - based on population frequency and variant effect).
* **NOTE - variants displayed here constitute the top 2000 variants for each of the ClinVar and non-ClinVar variant sets (due to display limitations with client-side tables)**
...
*  A total of n = __`r tot_variants[['class2']][['Other']]`__ <i><b>Other</b></i> variants (i.e. not submitted in ClinVar) are classified with a <i>Likely Benign</i> clinical significance by CPSR (ACMG criteria - based on population frequency and variant effect).
* **NOTE - variants displayed here constitute the top 2000 variants for each of the ClinVar and non-ClinVar variant sets (due to display limitations with client-side tables)**
...
*  A total of n = __`r tot_variants[['class1']][['Other']]`__ <i><b>Other</b></i> variants (i.e. not submitted in ClinVar) are classified with a <i>Benign</i> clinical significance by CPSR (ACMG criteria - based on population frequency and variant effect).
* **NOTE - variants displayed here constitute the top 2000 variants for each of the ClinVar and non-ClinVar variant sets (due to display limitations with client-side tables)**
