...
For the sample in question, `r cps_report$settings$sample_id`, CPSR does **not** perform any interrogation of _which genes that were subject to sequencing_. Rather, the user-defined __virtual__ gene panel is used to restrict the set of input variants that are subject to annotation and classification (i.e. listed within the _Variant classification_ section below).
:::
