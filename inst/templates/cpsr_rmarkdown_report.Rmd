...
nocite: |
  @Nakken2021-mb, @Huang2018-ah, @Richards2015-kj, @Maxwell2016-mr, @Amendola2016-pu, @Griffith2017-do, @Martin2019-nq, @Nykamp2017-rj
...
```{r conditional_secondary, child='cpsr_rmarkdown/cpsr_secondary_findings.Rmd', eval = as.logical(cps_report$settings$conf$variant_classification$secondary_findings)}
```
...
```{r conditional_gwas, child='cpsr_rmarkdown/cpsr_gwas.Rmd', eval = as.logical(cps_report$settings$conf$variant_classification$gwas_findings)}
```
