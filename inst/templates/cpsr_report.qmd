...
nocite: |
  ...
  @Martin2019-nq, @Dienstmann2015-od
format: 
  html:
...
logo_fname_path <- 
  system.file("extdata", "logo.png", package = "cpsr")
...
#| eval: !expr isTRUE(as.logical(cps_report$content$snv_indel$eval))
```
...
#| eval: !expr isTRUE(as.logical(cps_report$settings$conf$variant_classification$secondary_findings))
```
...
#| eval: !expr isTRUE(as.logical(cps_report$settings$conf$variant_classification$gwas_findings))
```
