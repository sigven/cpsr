...
The report is structured in multiple sections, described briefly below:
  ...
  3. __Variant classification__
     * For all coding and non-coding variants in the selected cancer predisposition geneset, 
       interactive variant tables are shown, with variants highlightd by their clinical significance:
         * Pathogenic
	      * Likely Pathogenic
...
Excel workbook (sheet *BIOMARKER_EVIDENCE*), contains information on matches between potential 
