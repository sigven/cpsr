...
- Infrastructure: major refactor of GitHub Actions workflow
  ...
  - pkgdown's auto development mode allows us to keep a dev website with documentation for the latest development version of pcgrr,
    which is now available at https://sigven.github.io/pcgr/dev/ (previously only stable versions were available on the website)
